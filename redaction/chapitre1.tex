...
Le problème est considéré à une dimension du fait de la longueur du guide et du domaine de fréquence de l'étude: on considère que seul le mode plan est propagatif. Le guide principal ayant un diamètre de 5 cm, le premier mode non plan se propage à partir de 4000 Hz. Les simulations et mesures ne seront donc faite que sur une bande de fréquences allant de $0$ à $1~kHz$.
...
Pour prendre en compte les pertes, on modifie l'expression de la constante de propagation et de l'impédance caractéristique avec les expressions de l'article ~\cite{slow} (voir la bibliographie de l'article pour plus de détail). Les expressions prenant en compte les pertes viscothermiques sont donc:
\begin{eqnarray*}
...
Dans la suite les paramètres de la simulation sont ceux de l'expérience dont nous disposons. Ces paramètres sont disponible en annexe \ref{annexe_corr}.
