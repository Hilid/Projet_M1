...
Le problème est considéré à une dimensions du fait de la longueur du guide et du domaine de fréquence de l'étude: on considère que seul le mode plan est propagatif. Pour tous les cas étudiés dans la suite, le guide principal ayant un diamètre de 5 cm, le premier mode non plan se propage au-delà de 4000 Hz. 
