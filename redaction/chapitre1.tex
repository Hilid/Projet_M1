...
\begin{figure}[h!]
	...
	\caption{Coefficients de réflexion (en haut) et de transmission (en bas) pour un réseau de 60 résonateurs avec $\bar{L}=10$ cm.}
\end{figure}

\section{Conclusion*} \todo[inline]{Conclusion partielle ?}
